...
import com.digitalpetri.enip.EtherNetIpServer;
import com.digitalpetri.enip.EtherNetIpServerConfig;
...
public class CipServer extends EtherNetIpServer implements CipServiceInvoker {
    ...
    public CipServer(EtherNetIpServerConfig config, EPath.PaddedEPath connectionPath) {
        super(config);
