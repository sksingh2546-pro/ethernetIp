...
public class EtherNetIpServerConfig {
    ...
    public static class Builder {
        ...
        /**
         * @see EtherNetIpServerConfig#getMaxIdle()
         */
        ...
        /**
         * @see EtherNetIpServerConfig#getMaxReconnectDelaySeconds()
         */
        ...
        /**
         * @see EtherNetIpServerConfig#isLazy()
         */
        ...
        /**
         * @see EtherNetIpServerConfig#isPersistent()
         */
        ...
        public EtherNetIpServerConfig build() {
            if (executor == null) {
            ...
            return new EtherNetIpServerConfig(
                hostname,
                port,
                vendorId,
                serialNumber,
